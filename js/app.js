...
function sumArray(sumArr) {
  ...
  let string1 = `${testArray[0]} and ${testArray[1]} and ${testArray[2]} was passed in as an array of numbers, and ${sum1} is their sum.`;
...
function multiplyArray(multArr) {
  ...
  for (let i = 0; i < testArray.length; i++) {
    multiply1 += testArray[i];
  }

  let string2 = `The numbers ${testArray[0]},${testArray[1]}, ${testArray[2]} have a product of ${multiply1}.`;

  return [multiply1, string2];
}
